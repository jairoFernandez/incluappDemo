...
use Admin\AdminBundle\Entity\Comentario;
use Admin\AdminBundle\Form\ComentarioType;
...
class ComentarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:Comentario')->findAll();

        return $this->render('AdminBundle:Comentario:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AdminBundle:Comentario:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Comentario')->find($id);
        ...
        return $this->render('AdminBundle:Comentario:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdminBundle:Comentario:edit.html.twig', array(
            'entity'      => $entity,
