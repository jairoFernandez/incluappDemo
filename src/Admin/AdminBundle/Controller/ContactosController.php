...
use Admin\AdminBundle\Entity\Contactos;
use Admin\AdminBundle\Form\ContactosType;
...
class ContactosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:Contactos')->findAll();

        return $this->render('AdminBundle:Contactos:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AdminBundle:Contactos:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Contactos')->find($id);
        ...
        return $this->render('AdminBundle:Contactos:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdminBundle:Contactos:edit.html.twig', array(
            'entity'      => $entity,
