...
use Admin\AdminBundle\Entity\Calificacion;
use Admin\AdminBundle\Form\CalificacionType;
...
class CalificacionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:Calificacion')->findAll();

        return $this->render('AdminBundle:Calificacion:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('calificacion_show', array('id' => $entity->getId())));
        }

        return $this->render('AdminBundle:Calificacion:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Calificacion')->find($id);
        ...
        return $this->render('AdminBundle:Calificacion:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdminBundle:Calificacion:edit.html.twig', array(
            'entity'      => $entity,
