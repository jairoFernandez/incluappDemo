...
use Admin\AdminBundle\Entity\Estado;
use Admin\AdminBundle\Form\EstadoType;
...
class EstadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:Estado')->findAll();

        return $this->render('AdminBundle:Estado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AdminBundle:Estado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Estado')->find($id);
        ...
        return $this->render('AdminBundle:Estado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AdminBundle:Estado:edit.html.twig', array(
            'entity'      => $entity,
